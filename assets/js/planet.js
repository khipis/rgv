if (BABYLON.Engine.isSupported()) {
    ...
    var flare00 = new BABYLON.LensFlare(0.1, 0, new BABYLON.Color3(1, 1, 1), "Flare3.png",
                                        lensFlareSystem);
    var flare01 = new BABYLON.LensFlare(0.4, 0.1, new BABYLON.Color3(1, 1, 1), "Flare.png",
                                        lensFlareSystem);
    var flare02 = new BABYLON.LensFlare(0.2, 0.2, new BABYLON.Color3(1, 1, 1), "Flare.png",
                                        lensFlareSystem);
    var flare02 = new BABYLON.LensFlare(0.1, 0.3, new BABYLON.Color3(1, 1, 1), "Flare3.png",
                                        lensFlareSystem);
    var flare03 = new BABYLON.LensFlare(0.3, 0.4, new BABYLON.Color3(0.5, 0.5, 1), "Flare.png",
                                        lensFlareSystem);
    var flare05 = new BABYLON.LensFlare(0.8, 1.0, new BABYLON.Color3(1, 1, 1), "Flare2.png",
                                        lensFlareSystem);
    var flare05 = new BABYLON.LensFlare(0.8, 1.0, new BABYLON.Color3(1, 1, 1), "Flare.png",
                                        lensFlareSystem);
    var flare02 = new BABYLON.LensFlare(0.1, 1.3, new BABYLON.Color3(1, 1, 1), "Flare.png",
                                        lensFlareSystem);
    var flare03 = new BABYLON.LensFlare(0.15, 1.4, new BABYLON.Color3(0.5, 0.5, 1.0), "Flare.png",
                                        lensFlareSystem);
    var flare04 = new BABYLON.LensFlare(0.05, 1.5, new BABYLON.Color3(1, 1, 1), "Flare3.png",
                                        lensFlareSystem);
